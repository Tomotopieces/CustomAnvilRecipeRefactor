...
public class PrefabButton {
    ...
    public static final InventoryGuiButton BUTTON_NOTHING =
            new InventoryGuiButtonBuilder()
                    .setMaterial(Material.BLACK_STAINED_GLASS_PANE)
                    .setName("").toButton();

    public static final InventoryGuiButton BUTTON_CREATION_MENU =
            new InventoryGuiButtonBuilder()
                    .setMaterial(Material.ANVIL)
                    .setName(ChatColor.YELLOW + "" + ChatColor.BOLD + "新建配方")
                    .addLore(ChatColor.WHITE + "点击进入新建配方界面").toButton();

    public static final InventoryGuiButton BUTTON_RECIPE_LIST_MENU =
            new InventoryGuiButtonBuilder()
                    .setMaterial(Material.PAPER)
                    .setName(ChatColor.YELLOW + "" + ChatColor.BOLD + "配方列表")
                    .addLore(ChatColor.WHITE + "点击进入配方列表界面").toButton();

    public static final InventoryGuiButton BUTTON_EXIT =
            new InventoryGuiButtonBuilder()
                    .setMaterial(Material.BARRIER)
                    .setName(ChatColor.RED + "" + ChatColor.BOLD + "退出").toButton();

    public static final InventoryGuiButton BUTTON_LEFT_ITEM_HINT =
            new InventoryGuiButtonBuilder()
    ...
    public static final InventoryGuiButton BUTTON_RIGHT_ITEM_HINT =
            new InventoryGuiButtonBuilder()
                    .setMaterial(Material.LIGHT_GRAY_STAINED_GLASS_PANE)
                    .setName(ChatColor.AQUA + "" + ChatColor.BOLD + "右物品")
                    .addLore(ChatColor.WHITE + "在这里放置配方所需的右边物品").toButton();

    public static final InventoryGuiButton BUTTON_REQUIRED_LEVEL =
            new InventoryGuiButtonBuilder()
    ...
    public static final InventoryGuiButton BUTTON_RESULT_ITEM_HINT =
            new InventoryGuiButtonBuilder()
                    .setMaterial(Material.LIGHT_GRAY_STAINED_GLASS_PANE)
                    .setName(ChatColor.AQUA + "" + ChatColor.BOLD + "结果物品")
                    .addLore(ChatColor.WHITE + "在这里放置配方的结果物品").toButton();

    public static final InventoryGuiButton BUTTON_SAVE_RECIPE =
            new InventoryGuiButtonBuilder()
